...
// import git from "../images/new_git.png"
    ...
    return(
        <div key="profi">
            ...
            <div className="container-fluid mt-5">
                ...
                <div className="row">
                    <div className="col-12 text-center mt-5">
                        <h1 className={styles.pro}>Proficiencies</h1>
                    </div>
                </div>
            ...
            <div className="row mt-4 px-5">
                ...
                <div className="col-6 col-lg-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 text-center">
                            <img src="reactApp.png" style={{width:"50%"}} className="img-fluid " alt="react_app"/>
                        </div>
                ...
                <div className="col-6 col-lg-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 text-center">
                            <img src="frontEnd.png" style={{width:"60%"}} className="img-fluid " alt="front-end"/>
                        </div>
                ...
                <div className="col-6 col-lg-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 text-center">
                            <img src="dataStructure.png" style={{width:"70%"}} className="img-fluid " alt="ds"/>
                        </div>
                ...
                <div className="col-6 col-lg-3">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12 text-center">
                            <img src="backEnd.png" style={{width:"55%"}} className="img-fluid " alt="ds"/>
                        </div>
            ...
            <div className="row mt-5">
                <div className="col-12 text-center mt-5">
                    <h1 className={styles.pro}>Progress</h1>
                </div>
            </div>
            ...
            <div className="row text-center p-3 mt-3">
                ...
                <div className="offset-2 col-4 offset-md-2 col-md-2 mb-4">
                    <div style={{border:"solid #FFC831 10px", height:"100px", width:"100px"}} className="rounded-circle mx-auto">
